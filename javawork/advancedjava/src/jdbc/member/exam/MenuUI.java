...
public class MenuUI {
	...
	public void findByAddrMenu(){
		...
		for(int i=0; i<size; i++)
		{
			...
			System.out.println(member.getId()+"\t"+member.getName()+"\t"+member.getAddr()+"\t"+member.getHiredate()+"\t"+member.getDeptno());
		}
	}
	...
	public void selectMenu(){
		...
		{
			MemberDTO member = memberlist.get(i);
			System.out.println(member.getId()+"\t"+member.getPass()+"\t"+member.getName()+"\t"+member.getAddr()+"\t"+member.getHiredate()+"\t"+member.getDeptno());
		}
	}
